...
python eval.py \
    ...
    --seed 42 \
    --output_dir /lustre/scratch/users/abhishek.maiti/HELMET_results/k2v2-jais2-sft-rag64k \
    --tag v1 \
    --model_name_or_path /lustre/scratch/users/abhishek.maiti/hf_ckpts/k2v2-instruct-jais-sft_64K \
