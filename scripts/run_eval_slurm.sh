...
CONFIGS=(recall.yaml rag.yaml longqa.yaml summ.yaml icl.yaml rerank.yaml cite.yaml alce_nocite.yaml)
#CONFIGS=(${CONFIGS[8]})
SEED=42
...
python scripts/collect_results.py --model $MNAME --output_dir $OUTPUT_DIR --tag $TAG --training_length 131072
