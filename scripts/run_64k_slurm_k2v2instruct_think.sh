...
#SBATCH --job-name=helmet_64k_think
...
MODEL_NAME="/lustre/scratch/shared-folders/cerebras-project/k2v2-instruct_64K_think"
MNAME="k2v2-instruct-64k-think"
OUTPUT_DIR="$RESULTS_DIR/$MNAME"

OPTIONS="--use_vllm --tensor_parallel_size $TP_SIZE --thinking"
